<?php
    ...
    $timing = $_POST['timing'];
    $checksql = "SELECT COUNT(*) FROM changement WHERE id_match = :id_match AND id_joueur1 = :id_joueur1 AND id_joueur2 = :id_joueur2 AND timing = :timing";
    ...
    else
    {
        ...
        VALUES (NULL, '$id_match', '$id_joueur1', '$id_joueur2', '$timing')";
