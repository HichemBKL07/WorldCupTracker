...
try {
    ...
    if (isset($_POST['id_temps_de_jeu']) && !isset($_POST['update'])) {
        ...
        if ($temps_de_jeu = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo "Temps : <input type='number' name='temps_de_jeu' value='" . htmlspecialchars($temps_de_jeu['temps_de_jeu']) . "'> <br>";
            echo "Numero : <input type='number' name='numero' value='" . htmlspecialchars($temps_de_jeu['numero']) . "'> <br>";
            echo "Poste : <input type='text' name='poste' value='" . htmlspecialchars($temps_de_jeu['poste']) . "'> <br>";
    ...
    if (isset($_POST['id_temps_de_jeu']) && isset($_POST['update'])) {
        ...
        $temps_de_jeu = $_POST['temps_de_jeu'];
        $numero = $_POST['numero'];
        $poste = $_POST['poste'];

        $sql = 'UPDATE temps_de_jeu SET id_joueur = :id_joueur, id_match = :id_match, temps_de_jeu = :temps_de_jeu, numero = :numero, poste = :poste
        WHERE id_temps_de_jeu = :id';
